...
import { getFollowing } from '../../../redux/actions/userActions';
...
const Following = ({ route, navigation }) => {
    ...
    const fetchNewFollowing = async () => {
        setisLoading(true);
        setError(false);

        const limit = 10;

        dispatch(getFollowing({ username, limit, page }))
            .then(res => {
        ...
        <View style={styles.container}>
            ...
            <SafeAreaView
                ...
                <View style={[styles.newModalHeader, {}]}>
                    ...
                    <Text numberOfLines={1} style={[styles.largeLabel, styles.textDark, styles.pt15]}>{count} Following</Text>
                </View>
